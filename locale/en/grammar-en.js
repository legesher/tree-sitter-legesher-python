...
module.exports = grammar({
  ...
  rules: {
    ...
    with_item: $ => prec.dynamic(
      -1,
      seq(field('value', $.expression), optional(seq('as', field('alias', $.pattern))))
    ),
    ...
    nonlocal_statement: $ =>
      seq('nonlocal', commaSep1($.identifier)),
    ...
    _right_hand_side: $ =>
      choice($.expression, $.expression_list, $.assignment, $.augmented_assignment, $.yield),
    ...
    await: $ => prec(PREC.unary, seq('await', $.expression)),
