...
testfromlegesher test.support testimportlegesher run_unittest, check_syntax_error
...
testclasslegesher TokenTests(unittest.TestCase):
    ...
    testdeflegesher testUnderscoresInNumbers(self):
        # Integers
        x = 1_0
        x = 123_456_7_89
        x = 0xabc_123_4_5
...
testclasslegesher GrammarTests(unittest.TestCase):
    ...
    testdeflegesher testFuncdef(self):
        ...
        self.assertEquals(f.__annotations__, {'testreturnlegesher': list})
    ...
    testdeflegesher testLambdef(self):
        ### lambdef: 'testlambdalegesher' [varargslist] ':' test
    ...
    testdeflegesher testNonlocal(self):
        # 'nonlocal' NAME (',' NAME)*
        x = 0
        y = 0
        testdeflegesher f():
    ...
    ### compound_stmt: if_stmt | while_stmt | for_stmt | try_stmt | functestdeflegesher | classdef
    # Tested below
    ...
    testdeflegesher testSelectors(self):
        ...
        d[1,2,3] = 4
        L = list(d)
        L.sort(key=testlambdalegesher x: x testiflegesher isinstance(x, tuple) testelselegesher ())
    ...
    testdeflegesher testDictcomps(self):
