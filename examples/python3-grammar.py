...
{class} GrammarTests(unittest.TestCase):
    ...
    ### compound_stmt: if_stmt | while_stmt | for_stmt | try_stmt | func{def} | classdef
    # Tested below
    ...
    {def} testComprehensionSpecials(self):
        ...
        # even though it's silly. Make sure it works (if{else} broke this.)
    ...
    {def} testIfElseExpr(self):
        # Test if{else} expressions in various cases
